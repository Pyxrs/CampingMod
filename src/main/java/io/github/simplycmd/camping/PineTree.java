...
public class PineTree {
    ...
    public static final RegistryEntry<ConfiguredFeature<RandomFeatureConfig, ?>> PINE_TREE_VEGITAL_FEATURE_CONFIGURED = ConfiguredFeatures.register(MOD_ID + ":pine_tree_configured", Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(PlacedFeatures.createEntry(PINE_TREES), 1F)), PlacedFeatures.createEntry(PINE_TREES))); // if it works, don't mess with it.
    public static final RegistryEntry<PlacedFeature> PINE_TREE_VEGITAL_FEATURE_PLACED = PlacedFeatures.register(MOD_ID + ":pine_tree_vegital", PINE_TREE_VEGITAL_FEATURE_CONFIGURED, PlacedFeatures.createCountExtraModifier(25, 1F, 1), SquarePlacementModifier.of(), NOT_IN_SURFACE_WATER_MODIFIER, PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP, BlockFilterPlacementModifier.of(BlockPredicate.wouldSurvive(Blocks.OAK_SAPLING.getDefaultState(), BlockPos.ORIGIN)), BiomePlacementModifier.of());
    public static final RegistryEntry<PlacedFeature> PINE_TREE_VEGITAL_FEATURE_PLACED_THICK = PlacedFeatures.register(MOD_ID + ":pine_tree_vegital_thick", PINE_TREE_VEGITAL_FEATURE_CONFIGURED, PlacedFeatures.createCountExtraModifier(50, 1F, 1), SquarePlacementModifier.of(), NOT_IN_SURFACE_WATER_MODIFIER, PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP, BlockFilterPlacementModifier.of(BlockPredicate.wouldSurvive(Blocks.OAK_SAPLING.getDefaultState(), BlockPos.ORIGIN)), BiomePlacementModifier.of());

    ...
    public void onInitializeDataGenerator(FabricDataGenerator fabricDataGenerator) {
        fabricDataGenerator.addProvider(new FabricRecipeProvider(fabricDataGenerator) {
            ...
            protected void generateRecipes(Consumer<RecipeJsonProvider> exporter) {
                ...
                createSignRecipe(Blocks.OAK_SIGN, Ingredient.ofItems(Main.PINE_PLANKS)).criterion(hasItem(Main.PINE_PLANKS), conditionsFromItem(Main.PINE_PLANKS)).offerTo(exporter);
